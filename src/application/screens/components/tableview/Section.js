...
class Section extends Component {
    constructor(props) {
        ...
        this.handleHighlightRow = index => !this.state.highlightedRowIndex
            && this.setState({
                highlightedRowIndex: index
            });
        this.handleUnHighlightRow = () => this.setState({
            highlightedRowIndex: undefined
        });
    }
    render() {
        const {allowFontScaling, children, footerComponent, headerComponent, headerTextColor, hideSeparator, footerTextColor, sectionPaddingBottom, sectionPaddingTop, sectionTintColor, separatorInsetLeft, separatorInsetRight, separatorTintColor} = this.props;
