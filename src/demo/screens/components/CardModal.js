...
export default class CardModal extends Component {
    ...
    renderBottom() {
        ...
        const plusButton = !this.state.activated ? <Animated.View style={{justifyContent: 'center', alignItems: 'center'}}>
            <Icon name="plus-circle" style={{fontSize: 24, color: this.props.color}}/>
        </Animated.View> : <Animated.View style={{justifyContent: 'center', alignItems: 'center'}}>
    ...
    renderContent() {
        ...
        return (
            <Animated.View style={{marginTop: 40, width: width, height: this.state.content_height, zIndex: -1,
